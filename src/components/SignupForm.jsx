      ...
      <div className="md:mt-2">
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          <button
            ...
            className="font-medium text-base bg-violet-500 text-white p-2 rounded-xl  active:scale-[0.98] transition-all active:duration-100 hover:scale-[1.01] ease-in-out"
          >
            Sign In
          </button>
        </div>
